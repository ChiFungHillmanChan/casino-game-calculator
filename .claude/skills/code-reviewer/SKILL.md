---
name: code-reviewer
description: Use when reviewing code changes, PRs, or ensuring code quality. Checks TypeScript safety, security, error handling, and project conventions.
---
...
- `core-rules` - SRP, module size, structure.md checks
- `typescript-rules` - Type safety, no `any`, hook patterns
...
- `code-cleanup` - Anti-patterns detection, infinite loops, resource leaks
